...
const ITEMS = [
  "Честно о том, почему усилий становится больше, а результат не всегда растёт",
  ...
  "Этот текст Музыкальный сет от Dj Андрей crash",
];
      ...
      <div className="container">
        <div className="panel">
          ...
          <p className={s.lead}>
            ...
            смыслы. Энергия, после которой невозможно вернуться в прежнюю точку.
          </p>
